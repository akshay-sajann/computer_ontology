...
computer_train = pd.read_csv(computer_train_path_2025)

alldesc_test = pd.read_csv(alldesc_test_path_2025)
computer_test = pd.read_csv(computer_test_path_2025)
...
with open(comp_rand_xg_path_2025, 'wb') as fp:
    pickle.dump(rand_scores, fp)
    print('scores saved successfully to file')

with open(comp_class_dist_path, 'wb') as fp:
