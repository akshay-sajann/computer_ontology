...
comp_dict = {"train": computer_train_path_2025, "test": computer_test_path_2025, "model":  {"rf": comp_rf_path_2025, "logreg": comp_logreg_path_2025}}
exp_dict = {"train": expert_train_path_2025, "test": expert_test_path_2025, "model": {"rf": exp_rf_path_2025, "logreg": exp_logreg_path_2025}}


path_dict ={"comp": comp_dict, "exp": exp_dict}

'''
models= {
    "xg": xgb.XGBClassifier(**xg_params_2025, n_jobs=-1)
}
'
'''

models= {"rf": RandomForestClassifier(**rf_params_2025, n_jobs=-1), "logreg": OneVsRestClassifier(LogisticRegression(**logreg_params_2025, n_jobs=-1))}
